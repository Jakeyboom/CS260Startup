...
- [X] **Stores data in MongoDB** - Converted local variables into calls to the database
- [X] **Stores credentials in MongoDB** - Upon account creation and login, user accounts are actualized in my MongoDB
